...
function navItem(id,label,href,icon,active) {
  return '<li><a class="nav-link '+(id===active?"active":"")+'" href="./'+href+'"><span class="nav-icon">'+icon+'</span><span>'+label+'</span></a></li>';
}
...
export function renderShell(options) {
  ...
  root.innerHTML=
    '<aside class="sidebar"><div class="sidebar-brand"><div class="brand-row"><div class="brand-mark">MM</div><div class="brand-text"><strong>MasterMinds</strong><span>FTC 30458</span></div></div><div class="sidebar-kicker">Team engineering documentation</div></div>'+
    '<nav class="sidebar-nav"><div class="nav-section"><div class="nav-label">Workspace</div><ul class="nav-list">'+
